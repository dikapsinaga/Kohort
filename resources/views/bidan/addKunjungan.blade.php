<div class="ui small modal add_kunjungan">
    ...
    <div class="content">
        ...
        <form id="form_add" class="ui form" method="POST">
            ...
            <div class="four wide field">
                ...
                <div class="ui calendar" id="add_tanggal_kunjungan">
                    <div class="ui input left icon">
                        <i class="calendar icon"></i>
                        <input type="text" placeholder="Date" name="add_tanggal_kunjungan">
            ...
            <div class="ten wide field">
                ...
                <div class="ui fluid multiple search selection dropdown">
                    <input type="hidden" name="add_tempat_pelayanan">
            ...
            <div class="ten wide field">
                ...
                <div class="ui fluid multiple search selection dropdown">
                    <input type="hidden" name="add_kode_pelayanan">
                    <i class="dropdown icon"></i>
            ...
            <div class="ten wide field">
                ...
                <div class="ui fluid multiple search selection dropdown">
                    <input type="hidden" name="add_penyakit">
                    <i class="dropdown icon"></i>
                    ...
                    <div class="menu">
                        ...
                        <div class="item" data-value="bengkak_muka_dan_tekanan_darah_tinggi">Bengkak Pada Muka/Tungkai Dan Tekanan Darah Tinggi</div>
